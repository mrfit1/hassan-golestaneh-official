  ...
  return <>
    ...
    <section className="achievementStories">
      <article className="achievementStory featuredAchievement">
        ...
        <div className="achievementArchiveGrid"><img src="/images/ireland-2016/trophy-medal.jpg" alt="2016 WFF World Championships trophy and medal"/><img src="/images/ireland-2016/awards-stage.jpg" alt="2016 WFF World Championships awards stage"/><img src="/images/ireland-2016/registration-collage.jpg" alt="2016 WFF registration archive"/><img src="/images/ireland-2016/event-collage.jpg" alt="2016 WFF event archive"/><img src="/images/ireland-2016/wristband.jpg" alt="2016 WFF competitor wristband"/><img src="/images/ireland-2016/stage.jpg" alt="2016 WFF World Championships stage"/></div>
      </article>
      <article className="achievementStory">
        ...
        <div className="achievementArchiveGrid huntingtonArchive"><img src="/images/huntington-2017/medal-stage.jpg" alt="2017 Huntington Beach medal moment"/><img src="/images/huntington-2017/back-pose.jpg" alt="2017 Huntington Beach competition back pose"/><img src="/images/huntington-2017/pro-qualified-stage.jpg" alt="2017 Huntington Beach Pro Qualified stage"/></div><div className="eventVideos"><EventVideo src="/videos/events/huntington-2017.mp4" label={c.footage}/></div>
      </article>
      <article className="achievementStory">
        ...
        <div className="achievementMedia arnoldSoloHero"><img src="/images/arnold-2017/stage-solo.jpg" alt="Hassan Golestaneh at Arnold Amateur 2017"/></div>
        <div className="achievementArchiveGrid arnoldArchive"><img src="/images/arnold-2017/credentials-collage.jpg" alt="Arnold Amateur 2017 credentials"/><img src="/images/arnold-2017/arnold-selfie.jpg" alt="Arnold Amateur 2017 with Arnold Schwarzenegger"/><img className="arnoldLineupFocus" src="/images/arnold-2017/stage-lineup.jpg" alt="Arnold Amateur 2017 lineup"/><img src="/images/arnold-2017/arnold-group.jpg" alt="Arnold Amateur 2017 group archive"/></div><div className="eventVideos"><EventVideo src="/videos/events/arnold-2017.mp4" label={c.footage}/></div>
      </article>
    </section>
  </>;
}
