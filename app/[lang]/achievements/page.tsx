...
export async function generateMetadata({params}:{params:Promise<{lang:string}>}):Promise<Metadata>{ const {lang}=await params; return pageMetadata(lang,'achievements','achievements'); }
  ...
  return <>
    ...
    <section className="achievementStories">
      ...
      <article className="achievementStory">
        ...
        <div className="achievementArchiveGrid"><img src="/images/arnold-2017/credentials-collage.jpg" alt="Arnold Amateur 2017 credentials"/><img src="/images/arnold-2017/arnold-selfie.jpg" alt="Arnold Amateur 2017 event archive"/><img src="/images/arnold-2017/stage-solo.jpg" alt="Arnold Amateur 2017 stage"/><img src="/images/arnold-2017/stage-lineup.jpg" alt="Arnold Amateur 2017 lineup"/><img src="/images/arnold-2017/arnold-group.jpg" alt="Arnold Amateur 2017 group archive"/><img src="/images/arnold-2017/media-backstage.jpg" alt="Arnold Amateur 2017 media archive"/></div><div className="eventVideos"><EventVideo src="/videos/events/arnold-2017.mp4" label={c.footage}/></div>
      </article>
    </section>
  </>;
}
